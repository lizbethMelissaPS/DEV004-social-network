...
const loginGoogle = () => signInWithPopup(auth, google);
...
const Login = () => {
    ...
    <article class="wrapper">
      ...
      <p class="or">or</p>
        <button id="fb-login" type="button" class="submit facebook">
          <img id="fb" alt="facebook icon"> Continue with Facebook
        </button>
  ...
  `;
  const fb2 = section.querySelector("#fb");
  fb2.setAttribute = facebook;
