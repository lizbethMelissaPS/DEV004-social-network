...
const sonder = "/assets/sonder.014ec1d3.png";
const Welcome = () => {
 ...
 * limitations under the License.
 */
async function signUp$1(auth2, request) {
...
async function createUserWithEmailAndPassword(auth2, email, password) {
  const authInternal = _castAuth(auth2);
  const response = await signUp$1(authInternal, {
    returnSecureToken: true,
    email,
    password
  });
...
const addUser = (email, password) => createUserWithEmailAndPassword(auth, email, password);
const login = (email, password) => signInWithEmailAndPassword(auth, email, password);
const google$1 = new GoogleAuthProvider();
const facebook$1 = new FacebookAuthProvider();
const loginGoogle = () => signInWithPopup(auth, google$1);
const loginFacebook = () => signInWithPopup(auth, facebook$1);
const logOut = () => signOut(auth);
const currentUser = () => auth.currentUser;
function showMessage(message, type = "sucess") {
  Toastify({
    text: message,
    duration: 3e3,
    destination: "",
...
const sonderIcon = "/assets/Sonder-icon.f9793e47.png";
const facebook = "data:image/png;base64,";
const google = "data:image/png;base64,";
async function loginWithValues(email, password) {
  try {
...
const db = uh(app);
const saveTask = (name2, email, uid, photo, img, description, location, date, like, likeUserId) => {
  Xl(Ja(db, "post"), {
    name: name2,
    email,
    uid,
...
const deleteDocPost = (id2) => Zl(Za(db, "post", id2));
const addLike = (id2, uid) => Yl(Za(db, "post", id2), { likeUserId: _f(uid) });
const unLike = (id2, uid) => Yl(Za(db, "post", id2), { likeUserId: wf(uid) });
const incrementLike = (id2) => Yl(Za(db, "post", id2), { like: mf(1) });
const decrementLike = (id2) => Yl(Za(db, "post", id2), { like: mf(-1) });
const share = "data:image/png;base64,";
const likeIcon = "/assets/like-icon.90cb3f29.svg";
const comment = "data:image/png;base64,";
const bucket = "data:image/png;base64,";
    ...
    const section = `
        <article class="post-box">
          ...
          <section class="interaction-box">
            <figure class=" item">
              <img data-id="${doc.id}" src=${likeIcon} alt="" class="icon-like">
...
const logoutIcon = "data:image/png;base64,";
const profileIcon = "data:image/png;base64,";
const homeIcon = "data:image/png;base64,";
const settingsIcon = "data:image/png;base64,";
const lougOutBtn = () => {
...
const createIcon = "data:image/png;base64,";
const likedIcon = "/assets/liked.11ccfeef.svg";
const home = () => {
  const main = document.createElement("main");
  const section = document.createElement("article");
  section.innerHTML = `
  ...
  onAuthStateChanged(auth, async (user) => {
    if (user) {
      const queryPost = ol(Ja(db, "post"), dl("date", "desc"));
      tf(queryPost, (querySnapshot) => {
  ...
  const createPost2 = section.querySelector("#createPost");
  createPost2.addEventListener("click", async () => {
...
function quotaExceeded(bucket2) {
  return new StorageError(StorageErrorCode.QUOTA_EXCEEDED, "Quota for bucket '" + bucket2 + "' exceeded, please view quota on https://firebase.google.com/pricing/.");
}
...
function invalidDefaultBucket(bucket2) {
  return new StorageError(StorageErrorCode.INVALID_DEFAULT_BUCKET, "Invalid default bucket '" + bucket2 + "'.");
}
...
function addRef(metadata, service) {
  function generateRef() {
    const bucket2 = metadata["bucket"];
    const path = metadata["fullPath"];
    const loc = new Location(bucket2, path);
...
function downloadUrlFromResourceString(metadata, resourceString, host, protocol) {
  ...
  const urls = tokensList.map((token) => {
    const bucket2 = metadata["bucket"];
    const path = metadata["fullPath"];
    const urlPart = "/b/" + encode(bucket2) + "/o/" + encode(path);
...
const photoIcon = "data:image/png;base64,";
const check = "/assets/check.325b5a4a.png";
const defaultProfile = "/assets/profile-pic.6b736330.png";
const createPost = () => {
  const main = document.createElement("main");
  const section = document.createElement("article");
  section.innerHTML = `
  ...
  createForm.addEventListener("submit", async (e) => {
    ...
    const defaultPic = defaultProfile;
